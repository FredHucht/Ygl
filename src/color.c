 ...
 *    (C) Fred Hucht 1993-2009
 *    EMail: fred<at>thp.Uni-Duisburg.de
 */

static const char vcid[] = "$Id: color.c,v 4.10 2009-09-10 09:28:35+02 fred Exp $";
...
/* $Log: color.c,v $
 * Revision 4.10  2009-09-10 09:28:35+02  fred
 * Bug in XGetImage() if YglDepth() == 32 (Thanks to Lothar Brendel for
 * bug fix)
 *
